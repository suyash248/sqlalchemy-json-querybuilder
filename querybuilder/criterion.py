...
from exceptions.exceptions import SqlAlchemyException, ExceptionBuilder, ErrorCode
...
class Criterion(object):
    ...
    def __init__(self, model_cls, field_name, field_value, operator_name):
        ...
        try:
            ...
            ExceptionBuilder(SqlAlchemyException).error(ErrorCode.INVALID_OPERATOR, operator_name).throw()
